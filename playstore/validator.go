...
//go:generate mockgen  -destination=mocks/playstore.go -package=mocks github.com/mihalydanis/go-iap/playstore IABProduct,IABSubscription,IABSubscriptionV2,IABMonetization
